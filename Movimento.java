...
public class Movimento extends AppCompatActivity implements View.OnClickListener{
    ...
    public JSONObject OnGuardarMovimento(View view) throws IOException {
        ...
        try {
            jsonObject.put("id_func", id_func.getText().toString());
            jsonObject.put("id_desp", id_desp.getText().toString());
            jsonObject.put("valor_desp", valor_desp.getText().toString());
            jsonObject.put("valor_km", valor_km.getText().toString());
            jsonObject.put("obs", obs.getText().toString());
            jsonObject.put("dataM", txtDate.getText().toString());
